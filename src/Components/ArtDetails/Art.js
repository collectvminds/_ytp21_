...
const Art = () => {
    ...
    return (
        <div className="artwrapper text-Dark bg-white">
            ...
            <div className="content overflow-hidden mobile:pt-20 tablet:pt-20 desktop:pt-36 mobile:px-10 mx-auto max-w-[1000px] ">
               <div className="art w-full overflow-x-hidden grid gap-5 laptop:grid-cols-1 desktop:grid-cols-1 mobile:grid-cols-1 mobile:px-14">
                    {/* <img  /> */}
                    ...
                    <div className="contryname flex flex-col">
                        <div className="flag flex flex-row items-center">
                            ...
                            <p className='desktop:text-3xl laptop:text-xl mobile:text-lg font-black text-Dark '>{data?.name}</p>
                        </div>
                        <div className="des">
